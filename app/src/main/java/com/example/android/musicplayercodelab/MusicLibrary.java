...
class MusicLibrary {
    ...
    public static List<MediaBrowserCompat.MediaItem> getMediaItems() {
        ...
        Log.i("MusicLibrary", "getMediaItems: music.size() = " + music.size());
